...
// 1. main path 정하기
string mainPath = "C:\/Users\/김화평\/Desktop\/ispd_2015_benchMark\/mgc_superblue12\/res\/ ";
float blockX = 1420.8, siteX = 0.1; float blockY = 2072, siteY = 0.9; float maxDisp = 50;
float marginA = 1.5; // getWindowCell
float marginB = 1.5; // calculateCost - distance 최대값을 얼마까지 감수할 것인지?
int netIter = 15000;
