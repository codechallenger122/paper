...
float marginA = 15; // getWindowCell
float marginB = 15; // calculateCost - distance 최대값을 얼마까지 감수할 것인지?
int netIter = 15000;
...
float marginA = 5.0; // getWindowCell
float marginB = 4.0; // calculateCost
int netIter = 10000;
string mainPath = "C:/Users/김화평/Desktop/ispd_2015_benchMark/mgc_des_perf_a/res/";
float blockX = 900, siteX = 0.2; float blockY = 900, siteY = 2; float maxDisp = 5000;
float marginA = 10.0; // getWindowCell
float marginB = 10.0; // calculateCost
int netIter = 10000;
...
float marginA = 10; // getWindowCell
float marginB = 1.3; // calculateCost - distance 최대값을 얼마까지 감수할 것인지?
int netIter = 15000;

string mainPath = "C:/Users/김화평/Desktop/ispd_2015_benchMark/mgc_fft_2/res/";
float blockX = 342, siteX = 0.2; float blockY = 342, siteY = 2; float maxDisp = 500;
float marginA = 4; // getWindowCell
float marginB = 3; // calculateCost - distance 최대값을 얼마까지 감수할 것인지?
int netIter = 5000;
...
float marginB = 1.3; // calculateCost
int netIter = 5000;



string mainPath = "C:/Users/김화평/Desktop/ispd_2015_benchMark/mgc_edit_dist_a/res/";
float blockX = 800, siteX = 0.2; float blockY = 800, siteY = 2; float maxDisp = 50;
float marginA = 3.0; // getWindowCell
float marginB = 3.0; // calculateCost
int netIter = 5000;



string mainPath = "C:/Users/김화평/Desktop/ispd_2015_benchMark/mgc_fft_a/res/";
float blockX = 800, siteX = 0.2; float blockY = 800, siteY = 2; float maxDisp = 50;
float marginA = 1.3; // getWindowCell
float marginB = 1.5; // calculateCost
int netIter = 1000;
