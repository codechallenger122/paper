...
float marginA = 12; // getWindowCell
float marginB = 12; // calculateCost
int netIter = 5000;
...
float marginB = 1; // calculateCost
int netIter = 10000;

string mainPath = "C:\/Users\/김화평\/Desktop\/workSpace\/ispd_2015_benchMarks\/mgc_fft_a\/res\/";
float blockX = 800, siteX = 0.2; float blockY = 800, siteY = 2; float maxDisp = 50;
float marginA = 14; // getWindowCell
float marginB = 14; // calculateCost
int netIter = 1000;
...
float marginA = 7.0; // getWindowCell
float marginB = 6.0; // calculateCost
int netIter = 30000;
string mainPath = "C:\/Users\/김화평\/Desktop\/workSpace\/ispd_2015_benchMarks\/mgc_fft_2\/res\/";
float blockX = 342, siteX = 0.2; float blockY = 342, siteY = 2; float maxDisp = 500;
float marginA = 4; // getWindowCell
float marginB = 5; // calculateCost - distance 최대값을 얼마까지 감수할 것인지?
int netIter = 15000;
