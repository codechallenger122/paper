# 0. globally path 선언.
#mainPath = "C:\/Users\/김화평\/Desktop\/workSpace\/benchMark\/mgc_edit_dist_a"
mainPath = "C:\/Users\/김화평\/Desktop\/workSpace\/ispd_2015_benchMarks\/mgc_edit_dist_a"
#mainPath = "C:\/Users\/김화평\/Desktop\/ispd_2015_benchMark\/mgc_des_perf_1"
...
def getNetInfo(designFile, cellNameList, instCIdMap, cIdInstMap):
	...
	with open(designFile, "r") as f:
		...
		while True:
			...
			if lines[0] in ["h0", "h1", "h2", "h3", "h4", "h5", "h6"]: continue # added in 22.11.15 for correcting the phenominon including macro in cells cosisting net.
	...
	with open(cellInfoFile, "w") as f:
		for cId in range(0,len(cIdNetDict.keys())):
			if str(cId) not in cIdNetDict.keys(): continue
